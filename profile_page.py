...
class Profile_page(QWidget):
    ...
    def profile_signals_connect(self):
        ...
        self.tree_model.setHorizontalHeaderLabels(["Account Name", ""])
    ...
    def show_profile_page(self):
        ...
        parent_window.ui.accounts_treeView.setModel(self.tree_model)
        ...
        for row_index in range(len(result_accounts)):
            ...
            parent_window.ui.accounts_treeView.setIndexWidget(self.tree_model.index(row_index, 1), see_account)
            account_name = self.tree_model.data(self.tree_model.index(row_index, 0))
    ...
    def change_username(self):
        ...
        """        if self.username_button_state is True:
